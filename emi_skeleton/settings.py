"""
Django settings for emi_skeleton project.
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": True,  # every refresh issues a new pair
    "BLACKLIST_AFTER_ROTATION": True,  # old refresh becomes unusable
    "UPDATE_LAST_LOGIN": True,  # auto‑update CustomUser.last_login
    "ALGORITHM": "HS256",
...
DATABASES = {
    'default': {
        ...
        'POSTGRES_HOST': config('DATABASE_HOST', default='localhost'),
        'POSTGRES_PORT': config('DATABASE_PORT', default='5432'),
    }
}
